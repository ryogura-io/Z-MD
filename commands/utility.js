    ...
    url: {
        ...
        execute: async (context) => {
            ...
            try {
                ...
                // Build targetMessage similar to your owner.js usage
                let targetMessage;
                if (cited) {
                    // quoted message exists (preferred)
                ...
                // Note: your owner.js used downloadMediaMessage(target, 'buffer', {}), so we follow that
