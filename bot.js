...
class Bot {
    ...
    async processMessage(message) {
        try {
            ...
            logger.info(`Command executed: ${commandName} by ${sender} in ${chatId}`);
            await command.execute(context);
            
            // Add reaction to command message
